 ...
 * com.aventstack.extentreports.observer.ExtentObserver; import
 ...
 * org.testng.Assert; import org.testng.ITestResult; import
 ...
 * public class Extent {
 * 
 * ExtentObserver[] htmlReporter;
 * 
 * ExtentReports extent; //helps to generate the logs in the test report.
 * ExtentTest test;
 * 
 * @BeforeTest public void startReport() { // initialize the HtmlReporter
 * htmlReporter = new ExtentReporter(System.getProperty("user.dir")
 ...
 * etc htmlReporter.length.setChartVisibilityOnOpen(true);
 ...
 * 
 * @Test public void test_1() { test = extent.createTest("Test Case 1",
 * "The test case 1 has passed"); Assert.assertTrue(true); }
 * 
 * 
 * @Test public void test_2() { test = extent.createTest("Test Case 2",
 * "The test case 2 has failed"); Assert.assertTrue(false); }
 * 
 * @Test public void test_3() { test = extent.createTest("Test Case 3",
 * "The test case 3 has been skipped"); throw new
 * SkipException("The test has been skipped"); }
 * 
